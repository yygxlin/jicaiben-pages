...
当前页面已包含使用说明、iCloud 云同步、StoreKit 内购/订阅状态、本地数据不上传业务服务器等说明；App 内使用说明、隐私政策和用户协议入口会加载这里的在线页面。协议/隐私正文以本目录为唯一维护源，不要在 iOS App 里再维护本地长文本。PRO 功能文案统一写“高级统计分析、多账本切换、关注分类、iCloud 云同步和多设备恢复”。
